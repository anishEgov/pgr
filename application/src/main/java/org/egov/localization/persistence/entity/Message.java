package org.egov.localization.persistence.entity;

import jakarta.persistence.*;
import lombok.*;
import org.egov.localization.domain.model.MessageIdentity;
...
public class Message {
	...
	public Message(org.egov.localization.domain.model.Message domainMessage) {
	...
	public org.egov.localization.domain.model.Message toDomain() {
		...
		final MessageIdentity messageIdentity = MessageIdentity.builder().tenant(tenant).module(module).locale(locale)
				.code(code).build();
		return org.egov.localization.domain.model.Message.builder().message(message).messageIdentity(messageIdentity).build();
	}

	public void update(org.egov.localization.domain.model.Message updatedMessage) {
